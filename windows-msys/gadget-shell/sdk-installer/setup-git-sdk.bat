...
@IF NOT DEFINED JENKINS_URL @(
	...
	@bash -c 'SHORTCUT="$HOME/Desktop/Gadget Shell @@BITNESS@@-bit.lnk"; test -f "$SHORTCUT" ^|^| /mingw64/bin/create-shortcut.exe --icon-file /msys2.ico --work-dir / /msys2.exe "$SHORTCUT"'
